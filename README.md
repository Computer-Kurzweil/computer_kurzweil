...
![Computing the Area outside the Mandelbrot Set](computer-kurzweil-app/src/site/resources/img/mandelbrot/screen03.png)
...
## Simulated Evolution
![Early Screen](computer-kurzweil-app/src/site/resources/img/simulatedevolution/screen1.png)
...
## Diffusion-limited aggregation (DLA) 
![The Dendrite after a while](computer-kurzweil-app/src/site/resources/img/dla/screen2.png)
...
## Cyclic Cellular Automaton (CCA)
![Later Screen](computer-kurzweil-app/src/site/resources/img/cca/screen2.png)
