...
import org.woehlke.computer.kurzweil.tabs.gameoflive.canvas.ConwaysGameOfLifeButtons;
...
public class ConwaysGameOfLifeTab extends TabPanel implements Tab, ConwaysGameOfLife {
    ...
    public String getTitle() {
        return ctx.getProperties().getGameoflive().getView().getTitle();
    }

    @Override
    public String getSubTitle() {
        return ctx.getProperties().getGameoflive().getView().getSubtitle();
    }
