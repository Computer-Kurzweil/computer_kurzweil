...
import org.woehlke.computer.kurzweil.tabs.sierpinskitriangle.canvas.SierpinskiTriangleColorScheme;
...
public class SierpinskiTriangleCanvas extends JComponent implements
    Serializable, SierpinskiTriangle {
    ...
    private final SierpinskiTriangleColorScheme colorScheme;
    ...
    public SierpinskiTriangleCanvas(SierpinskiTriangleContext tabCtx) {
        this.tabCtx = tabCtx;
        ...
        this.versions = 2;
        this.colorScheme = new SierpinskiTriangleColorScheme();
