package org.woehlke.computer.kurzweil.tabs.tetris;
...
import org.woehlke.computer.kurzweil.tabs.tetris.canvas.TetrisButtons;
...
public class TetrisTab extends TabPanel implements Tab, Tetris {
    ...
    public String getTitle() {
        return ctx.getProperties().getTetris().getView().getTitle();
    }

    @Override
    public String getSubTitle() {
        return ctx.getProperties().getTetris().getView().getSubtitle();
    }
