...
public class WaTorButtons extends JPanel implements GuiComponent, WaTor {
  ...
  public WaTorButtons(
    ...
    this.canvas = canvas;
    this.title = this.canvas.getTabCtx().getCtx().getProperties().getWator().getView().getNeighborhood().getTitle();
    this.buttonLabelVonNeumann = this.canvas.getTabCtx().getCtx().getProperties().getWator().getView().getNeighborhood().getTypeVonNeumann();
    this.buttonLabelMoore =this.canvas.getTabCtx().getCtx().getProperties().getWator().getView().getNeighborhood().getTypeMoore();
    this.buttonLabelWoehlke =this.canvas.getTabCtx().getCtx().getProperties().getWator().getView().getNeighborhood().getTypeWoehlke();
