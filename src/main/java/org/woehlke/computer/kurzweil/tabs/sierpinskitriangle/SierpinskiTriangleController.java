 ...
 */
public class SierpinskiTriangleController extends Thread
        implements TabController, SierpinskiTriangle {
    ...
    public SierpinskiTriangleController(
        SierpinskiTriangleContext tabCtx
    ) {
