...
import org.woehlke.computer.kurzweil.tabs.todo.tetris.canvas.TetrisColorScheme;
...
public class TetrisCanvas extends JComponent implements
    ...
    private final TetrisColorScheme colorScheme;
    ...
    public TetrisCanvas(TetrisContext tabCtx) {
        this.tabCtx = tabCtx;
        ...
        this.versions = 2;
        this.colorScheme = new TetrisColorScheme();
