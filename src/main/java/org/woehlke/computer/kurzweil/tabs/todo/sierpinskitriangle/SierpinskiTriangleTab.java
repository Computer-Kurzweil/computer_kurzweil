...
import org.woehlke.computer.kurzweil.tabs.todo.sierpinskitriangle.canvas.SierpinskiTriangleButtons;
...
public class SierpinskiTriangleTab extends TabPanel implements Tab, SierpinskiTriangle {

    private final SierpinskiTriangleContext tabCtx;
    private final SierpinskiTriangleCanvas canvas;

    private final SierpinskiTriangleButtons neighbourhoodButtonsPanel;
    private final PanelBottomButtons bottomButtonsPanel;

    public SierpinskiTriangleTab(ComputerKurzweilTabbedPane tabbedPane) {
        super(tabbedPane, TAB_TYPE);
        this.tabCtx = new SierpinskiTriangleContext(this);
        this.canvas = this.tabCtx.getCanvas();
        this.neighbourhoodButtonsPanel = new SierpinskiTriangleButtons(this.canvas);
