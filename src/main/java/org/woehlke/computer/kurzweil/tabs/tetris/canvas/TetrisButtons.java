package org.woehlke.computer.kurzweil.tabs.tetris.canvas;
...
import org.woehlke.computer.kurzweil.tabs.tetris.TetrisCanvas;
import org.woehlke.computer.kurzweil.tabs.tetris.Tetris;
...
public class TetrisButtons extends JPanel implements GuiComponent, Tetris {
  ...
  public TetrisButtons(
      TetrisCanvas canvas
  ) {
    this.canvas = canvas;
    this.title = this.canvas.getTabCtx().getCtx().getProperties().getTetris().getView().getNeighborhood().getTitle();
    this.buttonLabelVonNeumann = this.canvas.getTabCtx().getCtx().getProperties().getTetris().getView().getNeighborhood().getTypeVonNeumann();
    this.buttonLabelMoore =this.canvas.getTabCtx().getCtx().getProperties().getTetris().getView().getNeighborhood().getTypeMoore();
    this.buttonLabelWoehlke =this.canvas.getTabCtx().getCtx().getProperties().getTetris().getView().getNeighborhood().getTypeWoehlke();
