...
import org.woehlke.computer.kurzweil.tabs.todo.wator.canvas.WaTorColorScheme;
...
public class WaTorCanvas extends JComponent implements
    Serializable, TabCanvasWithModel, WaTor {
    ...
    private final WaTorColorScheme colorScheme;
    ...
    public WaTorCanvas(WaTorContext tabCtx) {
        this.tabCtx = tabCtx;
        ...
        this.versions = 2;
        this.colorScheme = new WaTorColorScheme();
