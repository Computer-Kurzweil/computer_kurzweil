...
@Log
@Component
public class SimulatedEvolutionTab extends JPanel implements ActionListener {
    ...
    public SimulatedEvolutionTab(ComputerKurzweilApplicationContext ctx) {
        ...
        this.ctx = ctx;
        PanelSubtitle panelSubtitle = PanelSubtitle.getPanelSubtitleForSimulatedEvolution(this.ctx);
