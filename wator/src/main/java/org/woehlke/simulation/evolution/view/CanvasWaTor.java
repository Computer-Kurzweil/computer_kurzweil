package org.woehlke.simulation.wator.view;
 ...
 * Time: 00:51:51
 */
public class CanvasWaTor extends JComponent implements GuiConfigDefault, Serializable {
  ...
  public CanvasWaTor(ObjectRegistry ctx) {
    this.ctx = ctx;
